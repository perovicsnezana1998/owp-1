...
var karteTabelaKupljene = $('#kupljeneKarte');
	...
	function getKarta() {
		$.get("KartaServlet", {'action': 'mojeKarteRezervisane'}, function(data) {
			console.log(data);
			...
			if (data.status == 'success') {
				...
				var kartePrikaz = data.mojeKarteRezervisane;
	...
	function getKartaKupljena() {
		$.get("KartaServlet", {'action': 'mojeKarteKupljene'}, function(data) {
			console.log(data);
			...
			if (data.status == 'success') {
				...
				var kartePrikaz = data.mojeKarteKupljene;
				console.log(kartePrikaz);
