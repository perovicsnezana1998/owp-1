$(document).ready(function() {
	...
	if(window.location.search.slice(1).split('&').length>2){
		var idk = window.location.search.slice(1).split('&')[1].split('=')[1];
	}
	console.log("id"+id);
	console.log("idP: "+idP);
	var params = {
	...
	//function getSedistaPolazni(){
		var paramsPolazni = {"action": "polazniSedistaIzmena","letIdPol": id,"kartaId":idk};
	...
	//function getSedistaPovratni(){
		var paramsPovratni = {"action": "povratniSedistaIzmena","letIdPol": idP,"kartaId":idk};
